...
export function Task({ task }) {
  ...
  return (
    <div className="grid grid-cols-[auto_1fr_auto] auto-rows-auto mb-2 text-base rounded-lg border border-border">
      {/* Checkbox for the task */}
      <Checkbox
        className="row-span-2 rounded-full mx-1 my-auto border border-blue-500"
      ...
      <div className="row-span-2 m-auto">
        ...
        >
          ...
          <DialogContent className="max-w-min sm:max-w-min p-2">
            <DialogHeader>
            ...
            <form className="text-sm" onSubmit={(event) => handleUpdate(event)}>
              <div className="flex flex-col justify-center content-start gap-3">
                <input
                  className="p-1 border border-border rounded-lg outline-none"
                  id="task"
                  name="task"
                  type="text"
                  value={taskDialog}
          ...
          {task.list === "Scheduled" &&
            taskDate?.toDateString() === today.toDateString() && (
              <>
                ...
                <p className="align-baseline">Due Today</p>
              </>
            )}
          {today < taskDate && (
            <>
              ...
              <p className="align-bottom">
                Due {taskDate.toLocaleDateString("en-US", options)}
              </p>
            </>
          )}
        </div>
        ...
        {task.note !== "" && (
          <>
            ...
            >
              <path
                fill="currentColor"
                d="M17.75 3A3.25 3.25 0 0 1 21 6.25V13h-4.75A3.25 3.25 0 0 0 13 16.25V21H6.25A3.25 3.25 0 0 1 3 17.75V6.25A3.25 3.25 0 0 1 6.25 3zm2.81 11.5-6.06 6.06v-4.31c0-.966.784-1.75 1.75-1.75z"
              ></path>
            </svg>
          </>
        )}
