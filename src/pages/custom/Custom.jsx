    ...
    <>
      <div className="flex content-center gap-1 mb-4">
        ...
        <Button
          ...
          variant="outline"
          size="secondary"
          className="rounded-full px-1 mt-2 mb-0 bg-red-500 text-red-200 sm:text-foreground sm:bg-background hover:bg-red-500 hover:text-red-200 border border-red-300 transition-colors duration-300"
        >
          <svg
